...
public class Transfer extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		int account_idTo = Integer.parseInt(request.getParameter("to").trim());
		int account_idFrom = Integer.parseInt(request.getParameter("from").trim());
        float amount = Float.parseFloat(request.getParameter("amount").trim());
      		  
        float balance = UtilDBDrew.TransferAccount(account_idTo, account_idFrom, amount);
        ...
        else
        {
            ...
            out.println(docType + //
                  ...
                  "<h1 align=\"center\">" + title + "</h1>\n");
            out.println("<ul>");
            out.println("<li> There is not enough money to complete this transfer");
            out.println("</ul>");
            out.println("<a href=\"/Individual/AccountInsert.html\">Create New Account</a> <br>\r\n" + 
            		"<a href=\"/Individual/AccountSearch.html\">Search Accounts By Account Number</a> <br>\r\n" + 
            		"<a href=\"/Individual/AccountSearchByID.html\">Search Accounts By Customer ID</a> <br>\r\n" + 
